...
//				R.layout.view_image_select, null);
		...
		mPointsLayout = (CirclePageIndicator) layout
				.findViewById(R.id.indicator);
//		addView(layout);
	}

	public void initImageRollView(ArrayList<String> imageUrls, boolean autoPlay) {
	 ...
	 *            是否自动播放
	 */
	public void initImageRollView(ArrayList<String> imageUrls,
		...
		public void onPageScrollStateChanged(int arg0) {
			...
			case ViewPager.SCROLL_STATE_IDLE:
				if (lastState == ViewPager.SCROLL_STATE_DRAGGING) {
					if (pager.getCurrentItem() == mImageUrls.size() - 1) {
						pager.setCurrentItem(0);
					} else if (pager.getCurrentItem() == 0) {
						pager.setCurrentItem(mImageUrls.size());
					}
				}
				break;
			}
	...
	private OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			if (mOnImageRollViewClickListener != null) {
				mOnImageRollViewClickListener.onClick(v, getCurrentItem());
			}
