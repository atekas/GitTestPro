...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void refreshHeaderView() {
		...
		case DOWN_PULL_REFRESH: // 下拉刷新状态
			tvState.setText(getResources().getString(R.string.pull_to_refresh_pull_label));
			ivArrow.startAnimation(downAnimation); // 执行向下旋转
			break;
		case RELEASE_REFRESH: // 松开刷新状态
			tvState.setText(getResources().getString(R.string.pull_to_refresh_release_label));
		...
		case REFRESHING: // 正在刷新中状态
			...
			tvState.setText(getResources().getString(R.string.pull_to_refresh_refreshing_label));
			break;
		default:
			break;
		}
	...
	public void hideHeaderView() {
		...
		tvState.setText(getResources().getString(R.string.pull_to_refresh_pull_label));
		tvLastUpdateTime.setText(getResources().getString(R.string.pull_to_refresh_last_time)+ getLastUpdateTime());
		currentState = DOWN_PULL_REFRESH;
	}
