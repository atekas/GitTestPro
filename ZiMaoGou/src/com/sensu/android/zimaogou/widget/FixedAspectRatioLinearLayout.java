...
public class FixedAspectRatioLinearLayout extends LinearLayout {
    ...
    public FixedAspectRatioLinearLayout(Context context, AttributeSet attrs) {
        ...
        mOrientation = a.getInt(R.styleable.FixedAspectRatio_fixOrientation, FIX_WIDTH);
        mAspectRatio = a.getFloat(R.styleable.FixedAspectRatio_aspectRatio, DEFAULT_ASPECT_RATIO);
        setWillNotDraw(true);
    }
