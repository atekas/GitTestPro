...
/**
 * Created by zhangwentao on 2015/11/23.
 *
 * 包含两个ScrollView的容器
 */
public class ScrollViewContainer extends RelativeLayout{
    ...
    private OnSlideFinish mOnSlideFinish;
            ...
            if (mMoveLen != 0) {
                if (state == AUTO_UP) {
                    ...
                    if (mMoveLen <= -mViewHeight) {
                        ...
                        state = DONE;
                        mCurrentViewIndex = 1;
                        if (mOnSlideFinish != null) {
                            mOnSlideFinish.slideFinish(true);
                        }
                    }
                    ...
                    if (mMoveLen >= 0) {
                        ...
                        mCurrentViewIndex = 0;
                        if (mOnSlideFinish != null) {
                            mOnSlideFinish.slideFinish(false);
                        }
                    }
                } else {
                    mTimer.cancel();
    ...
    public void setOnSlideFinish(OnSlideFinish onSlideFinish) {
        mOnSlideFinish = onSlideFinish;
    }
    ...
    public interface OnSlideFinish {
        void slideFinish(boolean isBottomView);
    }
}
