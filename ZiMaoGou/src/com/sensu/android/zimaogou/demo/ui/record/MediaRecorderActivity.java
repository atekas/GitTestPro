...
import com.sensu.android.zimaogou.demo.log.Logger;
import com.sensu.android.zimaogou.demo.ui.BaseActivity;
import com.sensu.android.zimaogou.demo.ui.record.views.ProgressView;
import com.sensu.android.zimaogou.demo.ui.record.views.ThemeRadioButton;
import com.sensu.android.zimaogou.demo.utils.ConvertToUtils;
import com.sensu.android.zimaogou.demo.utils.NetworkUtils;
...
public class MediaRecorderActivity extends BaseActivity implements OnErrorListener, OnClickListener, OnPreparedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPlayButton = (Button) findViewById(R.id.shoot_button);
		// ~~~ 绑定事件
//		findViewById(R.id.record_layout).setOnTouchListener(mOnSurfaceViewTouchListener);
		mPlayButton.setOnTouchListener(mOnSurfaceViewTouchListener);
...
//					mTitleNext.setText(R.string.record_camera_next);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == Activity.RESULT_OK) {
			...
			String path = data.getExtras().getString(TourBuySendActivity.VIDEO_PATH);
			Intent intent = new Intent(MediaRecorderActivity.this, TourBuySendActivity.class);
			intent.putExtra(TourBuySendActivity.IS_VIDEO, true);
			intent.putExtra(TourBuySendActivity.VIDEO_PATH, path);
