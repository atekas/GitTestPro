...
public class OrderDetailActivity extends BaseActivity {
    ...
    private void setData(){
        ...
        mode1.setTestImg(R.drawable.product_list_default);
        mode1.setTestTitle("懒人支架给你最好的体验");
        mode1.setPrice(100);
        mode1.setNum(1);
        pros1.add(mode1);
        ProductMode mode2 = new ProductMode();
        mode2.setTestImg(R.drawable.product_list_default);
        mode2.setPrice(101);
        mode2.setNum(1);
        ...
        mode3.setTestImg(R.drawable.product_list_default);
        mode3.setPrice(103);
        mode3.setNum(1);
        mode3.setTestTitle("YEASALAND——your best partner");
        pros3.add(mode3);
        ProductMode mode4 = new ProductMode();
        mode4.setTestImg(R.drawable.product_list_default);
        mode4.setPrice(104);
        mode4.setNum(1);
        mode4.setTestTitle("可伤过的痛过的我，向谁述说");
        pros4.add(mode4);
        ProductMode mode5 = new ProductMode();
        mode5.setTestImg(R.drawable.product_list_default);
        mode5.setPrice(105);
        mode5.setNum(1);
